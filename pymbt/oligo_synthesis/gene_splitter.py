    ...
    def split(self, max_len=1100, min_context=200, core=60, context=90,
        ...
        if overlap_n == 1:
            ...
            while True:
                ...
                olaps = [self.seq[x[0]:x[1]] for x in olap_start_stop]
                with_context = []
                ...
                olaps_w_context = [self.seq[x[0]:x[1]] for x in with_context]
        ...
        final_seqs = [self.seq[best_starts[i]:best_stops[i]] for i in
