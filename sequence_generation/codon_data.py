...
# TODO
# There's a lot that can be done to organize this better - name it better, include access methods, etc
...
source: http://www.kazusa.or.jp/codon/ (which cites GenBank, i.e. yeast genome project CDS database)
'''
codon_freq = {
'sc':{
